...
<body>
	<div class="container">
		<a
			href="/websiteVali/admin/quang-cao">Quay
			lại</a>
	</div>
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<form:form action="" method="POST" modelAttribute="quangCaoDTO"
					...
					<button type="reset" class="btn btn-danger" onclick="window.location.href='http://localhost:8080/websiteVali/admin/quang-cao'">Hủy</button>
