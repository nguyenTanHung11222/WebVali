...
<a href="<c:url value='/admin/san-pham/danh-sach-san-pham' />">Quay
	...
	<script type="text/javascript">
		function xoaMauSanPham(maSanPham, maMau){
			const url = "http://localhost:8080/websiteVali/api/san-pham/xoa-mau-san-pham?maSanPham=" + maSanPham + "&maMau=" + maMau;
			...
			$.ajax({
				...
				success: function (result) {
					if(result == 1){
						...
						window.location.href = "http://localhost:8080/websiteVali/admin/san-pham/xem-chi-tiet?id=" + maSanPham;
