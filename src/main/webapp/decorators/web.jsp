...
<link rel="stylesheet"
	...
	data-integrity="sha512-iBBXm8fW90+nuLcSKlbmrPcLa0OT92xO1BIsZ+ywDWZCvqsWgccV3gFoRBv0z+8dLJgyAHIhR35VZc2oM/gI1w=="
...
<body>
			...
			<div class="row">
				<div class="footer">
					...
					<sql:setDataSource var="snapshot" user="sa" password="sapassword"
						...
						url="jdbc:sqlserver://localhost:1433;databaseName=Vali" />
	...
	<script type="text/javascript">
		function searchType() {
			...
			window.location.href = "http://localhost:8080/WebsiteVali/danh-sach-san-pham/tim-kiem-san-pham?tenSanPham="
					+ textSearch + "&page=1";
		}
	</script>
</body>
